...
namespace Py
{
    struct Float : public __WrapperInterface
    {
        ...
        static Float         FromNew(PyObject* py_new_ref) { return { py_new_ref }; } // ! new reference construction
        /// Construct Float out of Borrowed PyObject Reference
        static Float         FromOld(PyObject* py_weak_ref) { Py_XINCREF(py_weak_ref); return { py_weak_ref }; } // ? borrowed reference construction
