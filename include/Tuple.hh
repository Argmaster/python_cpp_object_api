...
namespace Py
{
    struct Tuple : public __WrapperInterface
    {
        ...
        static Tuple         FromNew(PyObject* py_new_ref) { return { py_new_ref }; } // ! new reference construction
        /// Construct Tuple out of Borrowed PyObject Reference
        static Tuple         FromOld(PyObject* py_weak_ref) { Py_XINCREF(py_weak_ref); return { py_weak_ref }; } // ? borrowed reference construction
