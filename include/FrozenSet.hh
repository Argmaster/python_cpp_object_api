...
namespace Py
{
    struct FrozenSet : public __WrapperInterface
    {
        ...
        static FrozenSet         FromNew(PyObject* py_new_ref) { return { py_new_ref }; } // ! new reference construction
        /// Construct FrozenSet out of Borrowed PyObject Reference
        static FrozenSet         FromOld(PyObject* py_weak_ref) { Py_XINCREF(py_weak_ref); return { py_weak_ref }; } // ? borrowed reference construction
