...
namespace Py
{
    struct Bytes : public __WrapperInterface
    {
        ...
        static Bytes         FromNew(PyObject* py_new_ref) { return { py_new_ref }; } // ! new reference construction
        /// Construct Bytes out of Borrowed PyObject Reference
        static Bytes         FromOld(PyObject* py_weak_ref) { Py_XINCREF(py_weak_ref); return { py_weak_ref }; } // ? borrowed reference construction
