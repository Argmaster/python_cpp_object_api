    ...
    public:
        ...
        */
        ...
        static Str FromFormat(const std::string& _format, Args... args) {
            return PyBytes_FromFormat(_format.c_str(), args...);
        }
        ...
        /*
            ...
            raises TypeError.
        */
        char*       InnerBuffer() const;
        // Acquire string representation of contents of Bytes object
        ...
        */
        ...
        /*
            Create a Unicode object by decoding contents of this Bytes object. encoding and errors have
