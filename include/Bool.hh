...
namespace Py
{
    struct Bool : public __WrapperInterface
    {
        ...
        static Bool         FromNew(PyObject* py_new_ref) { return { py_new_ref }; } // ! new reference construction
        /// Construct Bool out of Borrowed PyObject Reference
        static Bool         FromOld(PyObject* py_weak_ref) { Py_XINCREF(py_weak_ref); return { py_weak_ref }; } // ? borrowed reference construction
