...
namespace Py
{
    struct Set : public __WrapperInterface
    {
        ...
        static Set         FromNew(PyObject* py_new_ref) { return { py_new_ref }; } // ! new reference construction
        /// Construct Set out of Borrowed PyObject Reference
        static Set         FromOld(PyObject* py_weak_ref) { Py_XINCREF(py_weak_ref); return { py_weak_ref }; } // ? borrowed reference construction
