...
namespace Py
{
    struct Complex : public __WrapperInterface
    {
        ...
        static Complex         FromNew(PyObject* py_new_ref) { return { py_new_ref }; } // ! new reference construction
        /// Construct Complex out of Borrowed PyObject Reference
        static Complex         FromOld(PyObject* py_weak_ref) { Py_XINCREF(py_weak_ref); return { py_weak_ref }; } // ? borrowed reference construction
