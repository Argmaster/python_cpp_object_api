...
namespace Py
{
    struct Long : public __WrapperInterface
    {
        ...
        static Long         FromNew(PyObject* py_new_ref) { return { py_new_ref }; } // ! new reference construction
        /// Construct Long out of Borrowed PyObject Reference
        static Long         FromOld(PyObject* py_weak_ref) { Py_XINCREF(py_weak_ref); return { py_weak_ref }; } // ? borrowed reference construction
